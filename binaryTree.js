...
// playBinarySearchTree.remove(26);
// playBinarySearchTree.remove(6);
// playBinarySearchTree.remove(7);

playBinarySearchTree.findHeight();

console.log(playBinarySearchTree.findHeight());
